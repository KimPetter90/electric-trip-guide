...
async function fetchNorwegianChargingStations(): Promise<ChargingStation[]> {
  const extendedStations: ChargingStation[] = [
    ...
    // Vestland og videre sørover
    {
      id: "tesla-supercharger-nordfjordeid",
      name: "Tesla Supercharger Nordfjordeid",
    ...
    {
      id: "tesla-supercharger-laerdal",
      name: "Tesla Supercharger Lærdal",
    ...
    {
      id: "circle-k-nesbyen",
      name: "Circle K Nesbyen",
      location: "Nesbyen, Viken",
      latitude: 60.5694,
      longitude: 9.1111,
      available: 4,
      total: 6,
    ...
    // Oslo-området
    {
      id: "tesla-supercharger-oslo-skøyen",
      name: "Tesla Supercharger Oslo Skøyen",
      location: "Oslo",
      latitude: 59.9267,
      longitude: 10.6789,
      available: 16,
    ...
    {
      id: "fortum-oslo-sentrum",
      name: "Fortum Oslo Sentrum",
      location: "Oslo",
      latitude: 59.9139,
      longitude: 10.7522,
      available: 12,
    ...
    {
      id: "circle-k-oslo-vest",
      name: "Circle K Oslo Vest",
      location: "Oslo",
      latitude: 59.9500,
      longitude: 10.6000,
      available: 8,
    ...
    {
      id: "tesla-supercharger-kongsberg",
      name: "Tesla Supercharger Kongsberg",
      location: "Kongsberg, Viken",
      latitude: 59.6686,
      longitude: 9.6511,
      available: 8,
      total: 12,
    ...
    {
      id: "circle-k-porsgrunn",
      name: "Circle K Porsgrunn",
      location: "Porsgrunn, Telemark",
      latitude: 59.1397,
      longitude: 9.6561,
      available: 5,
      total: 8,
    ...
    {
      id: "tesla-supercharger-arendal",
      name: "Tesla Supercharger Arendal",
    ...
    {
      id: "eviny-kristiansand",
      name: "Eviny Kristiansand",
    ...
    {
      id: "tesla-supercharger-kristiansand",
