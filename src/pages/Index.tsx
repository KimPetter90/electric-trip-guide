          ...
          <section className="space-y-8" aria-label="Ruteresultater">
            {!showRoute ? (
              ...
              <div className="space-y-6">
                ...
                <div data-testid="route-map" className="relative mt-8">{/* Økt avstand over kartet */}
                  {mapLoading && (
                ...
                {/* Route Statistics - moved to right column */}
                <div className="mt-8">
                  <div className="flex items-center gap-2 mb-6">
                    <BarChart3 className="h-5 w-5 text-primary animate-glow-pulse" />
                    <h3 className="text-2xl font-orbitron font-bold text-gradient animate-glow-pulse">Rutestatistikk</h3>
                  </div>
