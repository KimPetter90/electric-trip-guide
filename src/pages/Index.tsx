...
function Index() {
  ...
  const calculateApproximateDistance = (from: string, to: string): number => {
    ...
    const cityCoords: { [key: string]: [number, number] } = {
      ...
      'flekkefjord': [58.2971, 6.6602], 'karmøy': [59.2667, 5.2833], 'tysvær': [59.3167, 5.6333],
      ...
      'dønna': [66.1000, 12.5167], 'herøy': [66.0333, 12.5000], 'alstahaug': [65.9667, 12.5500],
      ...
      'sømna': [65.3333, 12.3500], 'brønnøy': [65.4667, 12.2167], 'bindal': [65.0833, 12.3500],
      'leka': [65.1000, 11.6167], 'vikna': [64.8500, 11.0333], 'nærøy': [64.8167, 11.9500],
      ...
      'vestvågøy': [68.1495, 13.6139], 'vågan': [68.2348, 14.5694], 'sortland': [68.6970, 15.4169],
      'øksnes': [69.0333, 15.4167], 'bø': [68.7500, 14.4667], 'hadsel': [68.5667, 14.6000],
      ...
      'jevnaker': [60.2667, 10.4000], 'oslo': [59.9139, 10.7522], 'kongsvinger': [60.1978, 12.0063],
      ...
      'folldal': [62.1333, 9.9500], 'os': [62.2333, 10.0333], 'dovre': [62.0833, 9.2833],
